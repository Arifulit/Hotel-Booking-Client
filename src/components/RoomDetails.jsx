...
//       // Update the availability of the selected room in the state
//       setSelectedRoom({ ...selectedRoom, available: false });
  
//       // Update the availability of the room in the main list
//       setRooms((prevRooms) =>
//         prevRooms.map((room) =>
...
//     } catch (error) {
//       console.error("Error booking the room:", error);
//       // Optionally, handle errors (you can re-enable the alert if necessary)
//     } finally {
//       setLoading(false);
//     }
//   };
...
const RoomDetails = () => {
  ...
  //     // Update the availability of the selected room in the state
  //     setSelectedRoom((prev) => ({ ...prev, available: false }));
