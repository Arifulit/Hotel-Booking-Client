...
//               rooms.available ? "hover:bg-green-100" : "hover:bg-red-100"
//             }`}
//             onClick={() => handleSelectRoom(rooms)}
//           >
//             <h2 className="text-xl font-semibold">{rooms.name}</h2>
//             <p>{rooms.description}</p>
//             <p className="text-gray-700">Price: ${rooms.price} per night</p>
//             <p className={rooms.available ? "text-green-500" : "text-red-500"}>
//               {rooms.available ? "Available" : "Not Available"}
//             </p>
//           </li>
